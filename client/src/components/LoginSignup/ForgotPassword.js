      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.data.check == "true") {
            axios
              ...
              .then((res) => {
                ...
                if (res.data.message == "Success") {
                  ...
                  toast.success("DDusng Email roi");
                } else {
                  toast.error("Bị lỗi gì đó rồi");
                }
              })
              .catch((error) => {
            ...
            toast.error("Email này chưa có tồn tại");
          }
          setIsLoading(false);
        })
        .catch((error) => {
  ...
  return (
    <div className="inputs">
      ...
      <div class="text-center fs-6">
        <a href="/login">Sing up</a> or <a href="/login">Sign in</a>
      </div>
    </div>
  );
};
